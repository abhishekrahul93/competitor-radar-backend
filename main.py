...
from app.api import competitors, scanning, changes, reports, auth, demo, payments, export, seo, social, chat, teams, slack, battlecards
...
app.include_router(battlecards.router, prefix="/api", tags=["Battlecards"])
@app.get("/")
async def root():
